...
```JSON
{
  ...
  "Experiences": ["Web-development (MERN)", "Game-development/Game-Design", "Low-Level Hardware-development"],
  "Languages": ["C/C++", "Python", "Java/Kotlin (Basic Knowledge)", "GDScript", "HTML/CSS/JS", "PHP", "MySQL", "x_86 ASM (Basic Knowledge)"],
  "Tools": ["Git/Github", "CMake", "Godot Engine", "VSCode", "Intellij IDEA/Pycharm"],
  "Frameworks and Libraries": ["SFML/SDL2", "React", "NodeJS/ExpressJS" ,"Laravel (Basic Knowledge)", "Tkinter (Python)"]
